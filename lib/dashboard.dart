            ...
            ListTile(
              ...
              onTap: () {
                setState(() {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Quizbee()),
                  );
          ...
          child: Row(
            ...
            children: <Widget>[
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                buildDetailText(
                    color: Colors.white, count: index + 1, text: 'Rank'),
                buildDetailText(
                ...
                buildDetailText(
                    ...
                    text: 'Recovered'),
                buildDetailText(
                    color: Colors.red, count: item.deaths, text: 'Deceased'),
              ]),
            ],
          ),
        )
